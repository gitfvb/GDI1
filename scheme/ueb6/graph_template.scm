...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname graph_template) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
...
;           [else (foldl
;                  (lambda (x c) (append c (if (boolean? (calc-route x route)) empty x)))
;                  false
;                  neighbors-list)] ;; Rekursiver Aufruf mit foldl
;           ))))
;    (calc-route start empty)
;    ))
