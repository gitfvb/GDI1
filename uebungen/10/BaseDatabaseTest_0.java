...
public class BaseDatabaseTest {
  ...
  public void addingDuplicates() {
    ...
    assertFalse(msg1, dbase.addEntry(e3));
    assertFalse(msg1, dbase.addEntry(e4));
    assertFalse(msg1, dbase.addEntry(e5));
  ...
  public void getSize() {
    ...
    assertTrue(msg2, dbase.addEntry(e7));

    assertEquals(msg1, 7, dbase.getSize());

    assertTrue(msg3, dbase.deleteEntry(e7));
    assertEquals(msg0, 6, dbase.getSize());
  }
  ...
  public void deleteEntry() {
    ...
    assertTrue(msg0, dbase.deleteEntry(e4));
    assertTrue(msg0, dbase.deleteEntry(e5));
    assertTrue(msg0, dbase.deleteEntry(e6));
    assertEquals(0, dbase.getSize());
  ...
  public void getPos() {
    ...
    assertEquals(msg0, 2, dbase.getPos(e3));
    assertEquals(msg0, 3, dbase.getPos(e4));
    assertEquals(msg0, 4, dbase.getPos(e5));
    assertEquals(msg0, 5, dbase.getPos(e6));

    assertTrue(msg0, dbase.deleteEntry(e1));
    assertEquals(msg0, -1, dbase.getPos(e1));
    assertEquals(msg0, 0, dbase.getPos(e2));
    assertEquals(msg0, 1, dbase.getPos(e3));
    assertEquals(msg0, 2, dbase.getPos(e4));
    assertEquals(msg0, 3, dbase.getPos(e5));
    assertEquals(msg0, 4, dbase.getPos(e6));

    assertTrue(msg1, dbase.deleteEntry(e2));
    assertEquals(msg0, -1, dbase.getPos(e2));
    assertEquals(msg0, 0, dbase.getPos(e3));
    assertEquals(msg0, 1, dbase.getPos(e4));
    assertEquals(msg0, 2, dbase.getPos(e5));
...
/*  @Test
  public void getEntry() {
    ...
    assertTrue(msg0, dbase.getEntry(0).equals(e1));
    assertTrue(msg0, dbase.getEntry(1).equals(e2));
    assertTrue(msg0, dbase.getEntry(2).equals(e3));
    assertTrue(msg0, dbase.getEntry(3).equals(e4));
    assertTrue(msg0, dbase.getEntry(4).equals(e5));
    assertTrue(msg0, dbase.getEntry(5).equals(e6));

    assertTrue(msg1, dbase.deleteEntry(e6));
    assertTrue(msg0, dbase.getEntry(4).equals(e5));
  }*/

//  @Test
//  public void test_updateEntry() {
//    String msg0 = "Datenbank Eintrag wurde nicht korrekt geändert.", msg1 = "Datensatz befindet sich nicht in der korrekten Position.";
//
