...
public interface AdditionalOperations {
  /**
   * Perform a set complement of the current
   * database and the argument.
   * 
   * @param data The database with which the current database
   * will be merged by the complement operator
   * @return the number of elements in the current database after
   ...
   * 
   * @param data The database with which the current database
   * will be merged by the intersection operator
   * @return the number of elements in the current database after
   * the operation has been executed
   */
  ...
  /**
   * Perform a set union (German "Vereinigung") of the current
   * database and the argument.
   * 
   * @param data The database with which the current database
   * will be merged by the union operator
   * @return the number of elements in the current database after
   * the operation has been executed
   */
