...
public class ConnectFour extends ConsoleProgram /* DialogProgram */ {
	...
	/**
	 * Test whether there are four gaming pieces in a direction. The direction
	 * can be checked by two modifiers. The direction should be positive (1),
	 * negative (-1) or deactivated (0).
	 * 
	 * @param mod_x
	...
	private boolean checkDirections(int mod_x, int mod_y, int x, int y) {
		...
		return (result_counter >= 3); // this is 3 because the given coordinate
		// is not countered
	}
